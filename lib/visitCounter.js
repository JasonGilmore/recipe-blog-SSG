...
function middleware(req, res, next) {
    try {
        ...
        const isTest = req.query.test === 'true' || (typeof req.body?.pathname === 'string' && req.body.pathname.includes('test=true'));
        ...
        if (req.method === 'POST' && lowerCasePath === '/track-event' && isTest) {
