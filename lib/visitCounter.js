...
// Count will be saved on the next saveVisits
...
// Adds unique visits to visitCounter, to be saved on the next saveVisits
// Called at the start of the next day and resets the visit counter
function addUniqueVisits() {
    ...
    thirtyDaysAgo.setDate(thirtyDaysAgo.getDate() - 30); //.setHours(0, 0, 0, 0);
...
// Add the unique visits to visitCounter from today at the start of the next day. Repeat every 24 hours
const now = new Date();
